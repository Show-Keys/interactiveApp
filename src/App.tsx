...
const departments: DepartmentData[] = [
  {
    ...
    subDepartments: [
      'قسم المتابعة',
      'قسم استقبال وتسجيل الطلبات',
      'قاعة الخدمة الموحدة',
      'فريق المنصة الوطنية للمقترحات والشكاوى والبلاغات (تجاوب)',
    ],
    responsibilities: [
      'متابعة الطلبات والمعاملات حتى إنجازها',
      'متابعة مؤشرات الأداء وقياس رضا العملاء',
      'تسجيل وتدقيق الطلبات',
      'تنظيم دخول المراجعين',
      'التنسيق مع القطاعات لإنجاز المعاملات بسرعة',
      'إدارة الطلبات الواردة عبر المنصة',
      'رفع التقارير الدورية للجهات العليا',
      'تسجيل البلاغات الواردة عبر مركز الاتصال',
    ],
  },
  {
    ...
    subDepartments: ['قسم التواصل الاستراتيجي', 'قسم التواصل الرقمي', 'قسم الإعلام', 'قسم المحتوى الإبداعي'],
    responsibilities: [
      'إعداد وتنفيذ الخطط الإعلامية',
      'إدارة الفعاليات الإعلامية',
      'توحيد الرسائل وإدارة الأزمات',
      'إدارة المحتوى الرقمي',
      'تشغيل المنصات الرقمية',
      'رصد وسائل الإعلام',
      'إعداد المحتوى الإعلامي',
      'التواصل مع وسائل الإعلام',
      'التغطية الإعلامية لفعاليات ومشاريع الوزارة',
      'إدارة الهوية البصرية',
      'تصميم المحتوى الإعلامي',
  ...
  },
  {
    ...
    responsibilities: [
      'متابعة تحويل الوثائق',
      'فرز الوثائق للترحيل أو الإتلاف',
      'تنظيم الوثائق في المخازن',
      'تسجيل البريد الصادر والوارد',
      'حفظ نسخ من البريد',
      'توجيه البريد الصادر والوارد',
      'إعداد نظام تصنيف الوثائق الإدارية',
      'ضمان تطبيق القوانين واللوائح',
      'دعم ومتابعة تطبيق إدارة الوثائق',
    ],
  },
  {
    ...
    subDepartments: ['قسم الدعاوى والتقاضي', 'قسم الدراسات القانونية والاتفاقيات', 'قسم المتابعة القانونية'],
    responsibilities: [
      'قيد ومتابعة القضايا',
      'تمثيل الوزارة قضائيًا',
      'إعداد ومتابعة الإجراءات القانونية',
      'دراسة المواضيع المحالة',
      'إجراء البحوث القانونية',
      'صياغة ومراجعة التشريعات',
      'مراجعة الاتفاقيات ومذكرات التفاهم',
      'مراجعة العقود والمناقصات',
      'متابعة تنفيذ الأحكام',
      'قيد طلبات التنفيذ',
      'متابعة أوامر التنفيذ',
    ],
  },
  {
    ...
    subDepartments: [],
    responsibilities: [
      'توثيق المستندات والوثائق وتأمين إيصالها',
      'التنسيق مع المنظمات الإقليمية والدولية',
      'تعزيز سبل التعاون بين الوزارة والمنظمات الدولية',
      'التنسيق لتنفيذ الاتفاقيات ومذكرات التفاهم',
      'التنسيق لمشاركة الوزارة في المؤتمرات داخل وخارج السلطنة',
      'إعداد وتنظيم برامج ووفود الوزارة بالتنسيق مع الجهات المختصة',
    ],
  },
  {
    ...
    subDepartments: [
      ...
      'قسم إدارة ومتابعة أوامر التغيير',
      'قسم تصنيف وتأهيل الشركات',
    ],
    responsibilities: [
      'إعداد ودراسة وطرح المناقصات ومتابعتها',
      'مراجعة التحليل الفني والمالي',
      'إدارة ومتابعة العقود',
      'إعداد وثائق العقود',
      'إدارة النزاعات',
      'تقييم أداء الشركات',
      'دراسة طلبات أوامر التغيير والملاحق',
      'استيفاء متطلبات إصدارها',
      'متابعة أداء المشاريع والاستراتيجيات',
      'التفاوض',
      'التأهيل المسبق للشركات',
      'تصنيف الشركات',
    ],
  },
  {
    ...
    subDepartments: ['قسم المراجعة المالية', 'قسم التدقيق التخصصي', 'قسم التدقيق المالي والإداري'],
    responsibilities: [
      'مراجعة سندات الصرف',
      'مراجعة الموازنات',
      'مراجعة إيرادات الوزارة',
      'الجرد المادي للخزائن',
      'مهام رقابية تقنية (تقنية المعلومات والاتصالات)',
      'مهام رقابية في المشاريع (الطرق والموانئ)',
      'مهام رقابية مالية',
      'مهام رقابية على الوحدات الإدارية',
    ],
  },
  {
    ...
    responsibilities: [
      ...
      'التنسيق مع الجهات',
      'الضبطية القضائية',
      'الإشراف على أمن الوزارة',
      'إصدار البطاقات الوظيفية',
      'إصدار التصاريح للمخولين',
      'التفتيش والرقابة',
      'التحكم بالأنظمة الأمنية',
    ],
  },
  {
    ...
    subDepartments: [],
    responsibilities: [
      'تشغيل أمن المعلومات (ISO 27001)',
      'إدارة أمن سيبراني متكاملة',
      'الحماية، التدقيق الدوري، الصيانة الوقائية',
      'تحليل المخاطر وسياسات الوصول',
      'التوثيق الأمني',
      'التدريب والتوعية التقنية',
      'مراقبة الشبكات',
      'إدارة الصلاحيات',
  ...
  },
  {
    ...
    responsibilities: [
      'استلام وتقييم البلاغ',
      'الوصول لموقع الحادث بأقرب وقت',
      'تعيين المحقق المسؤول',
      'التنسيق مع الجهات المعنية',
      'دراسة موقع الحادث',
      'منع الدخول غير المصرح به',
      'استدعاء الأشخاص واستجوابهم',
      'حفظ السجلات بسرية وأمان',
      'إعداد التقرير النهائي ومتابعة التوصيات',
    ],
  },
  {
  ...
  },
  {
    ...
    subDepartments: [],
    responsibilities: [
      'إعداد المواضيع والخطابات الرسمية والتقارير',
      'إعداد وتسجيل وتوزيع القرارات الوزارية والتعاميم',
      'الدعم والمساندة لقطاعات الوزارة مع الجهات الأخرى',
      'المتابعة لكافة المواضيع الصادرة والواردة',
      'إعداد تقارير نصف سنوية عن المخاطبات والقرارات',
      'توفير البيانات والمعلومات لمكتب الوزير وتقسيمات الوزارة',
      'توثيق المستندات والوثائق وتأمين إيصالها',
    ],
  },
  {
    ...
    responsibilities: [
      'الإشراف على الاجتماعات وإعداد الرسائل والجدول',
      'التنسيق مع المجالس واللجان بشأن القرارات',
      'متابعة تنفيذ قرارات الوزارة الخاصة بالمجالس واللجان',
      'حفظ الملفات الخاصة بالمجالس واللجان',
      'التواصل مع الجهات الخارجية المختصة',
    ],
  },
  {
    nameAr: 'دائرة العلاقات العامة',
    nameEn: 'Public Relations Department',
    color: '#0ea5e9',
    secondaryColor: '#38bdf8',
    size: 118,
    planetType: 'public-relations',
    purpose: 'تعزيز صورة الوزارة وبناء علاقات فعّالة مع الشركاء والضيوف من خلال الفعاليات والضيافة المؤسسية.',
    subDepartments: ['قسم الأنشطة والفعاليات', 'قسم الاستقبال والضيافة'],
    responsibilities: [
      'تنظيم الفعاليات',
      'تنظيم الأنشطة الداخلية للموظفين',
      'توفير الهدايا التذكارية للفعاليات',
      'توفير حوافز وخصومات للموظفين',
      'طلبات الرعايات والدعم للفعاليات',
      'استقبال وتوديع ضيوف الوزارة',
      'توفير الضيافة (التغذية / الحلوى)',
      'حجوزات الفنادق (الإقامة / الغرف)',
      'استخراج التأشيرات للموظفين والوفود',
      'إصدار جوازات الخدمة للموظفين',
      'استخراج تصاريح المطار',
      'توفير الهدايا التذكارية والوقود',
    ],
  },
];
